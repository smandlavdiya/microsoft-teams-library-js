...
export const enum ApiName {
  ...
  // Offline Storage
  OfflineStorage_RegisterSchema = 'offlineStorage.registerSchema',
  OfflineStorage_HasSchema = 'offlineStorage.hasSchema',
  OfflineStorage_ListSchemas = 'offlineStorage.listSchemas',
  OfflineStorage_MigrateSchema = 'offlineStorage.migrateSchema',
  OfflineStorage_RemoveSchema = 'offlineStorage.removeSchema',
  OfflineStorage_Drafts_Create = 'offlineStorage.drafts.create',
  OfflineStorage_Drafts_Update = 'offlineStorage.drafts.update',
  OfflineStorage_Drafts_Get = 'offlineStorage.drafts.get',
  OfflineStorage_Drafts_Query = 'offlineStorage.drafts.query',
  OfflineStorage_Drafts_Remove = 'offlineStorage.drafts.remove',
  OfflineStorage_Drafts_Submit = 'offlineStorage.drafts.submit',
  OfflineStorage_Inbox_Get = 'offlineStorage.inbox.get',
  OfflineStorage_Inbox_Query = 'offlineStorage.inbox.query',
  OfflineStorage_Inbox_GetCount = 'offlineStorage.inbox.getCount',
  OfflineStorage_Inbox_MarkAsRead = 'offlineStorage.inbox.markAsRead',
  OfflineStorage_Inbox_RegisterOnUpdateHandler = 'offlineStorage.inbox.registerOnUpdateHandler',
  OfflineStorage_Outbox_List = 'offlineStorage.outbox.list',
  OfflineStorage_Outbox_GetSummary = 'offlineStorage.outbox.getSummary',
  OfflineStorage_Outbox_Retry = 'offlineStorage.outbox.retry',
  OfflineStorage_Outbox_Cancel = 'offlineStorage.outbox.cancel',
  OfflineStorage_Outbox_RegisterOnStatusChangeHandler = 'offlineStorage.outbox.registerOnStatusChangeHandler',
  OfflineStorage_Sent_Get = 'offlineStorage.sent.get',
  OfflineStorage_Sent_Query = 'offlineStorage.sent.query',
  OfflineStorage_Sent_ListSince = 'offlineStorage.sent.listSince',
  OfflineStorage_Sent_Purge = 'offlineStorage.sent.purge',
  OfflineStorage_Sync_Trigger = 'offlineStorage.sync.trigger',
  OfflineStorage_Sync_GetStatus = 'offlineStorage.sync.getStatus',
  OfflineStorage_Sync_SetConflictStrategy = 'offlineStorage.sync.setConflictStrategy',
  OfflineStorage_Sync_ResolveConflict = 'offlineStorage.sync.resolveConflict',
  OfflineStorage_Sync_RegisterOnStatusChangeHandler = 'offlineStorage.sync.registerOnStatusChangeHandler',
  OfflineStorage_Sync_RegisterOnConflictHandler = 'offlineStorage.sync.registerOnConflictHandler',
